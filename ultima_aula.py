...
''')
                        ...
                        while True:    
                            buscar_classificacao = input('Digite o nome do produto para modificar sua classificação ou digite "7" para voltar ao menu: ').strip()
                            ...
                            for item in lista_de_produto:
                                if item['nome'].lower() == buscar_classificacao.lower():
                                    ...
                                    break  # Para sair do loop após a atualização
